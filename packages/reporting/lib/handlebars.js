...
function jsData(report,rtOptions){
    ...
    return function( dataset, options) {
        if (report) {
            // console.log(" jsData " + dataset)
            // console.log(" jsData " + JSON.stringify(Object.keys(options)))
            // console.log(" jsData " + JSON.stringify(options.hash))
            //console.log(" jsData " + JSON.stringify(Object.keys(options.data)))
            let opt = {
                display:true
            }
            ...
            let result = report.getDataset(dataset).getResult(opt)

            // include by specifying  html=true as an option
